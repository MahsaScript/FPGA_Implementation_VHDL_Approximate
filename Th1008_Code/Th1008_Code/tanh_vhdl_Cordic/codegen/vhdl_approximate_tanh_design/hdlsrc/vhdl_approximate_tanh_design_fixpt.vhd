...
ENTITY vhdl_approximate_tanh_design_fixpt IS
  PORT( x                                 :   IN    vector_of_std_logic_vector14(0 TO 1000);  -- sfix14_En10 [1001]
        y_out                             :   OUT   vector_of_std_logic_vector14(0 TO 1000)  -- sfix14_En13 [1001]
        );
...
ARCHITECTURE rtl OF vhdl_approximate_tanh_design_fixpt IS
  ...
  -- Signals
  SIGNAL x_signed                         : vector_of_signed14(0 TO 1000);  -- sfix14_En10 [1001]
  SIGNAL y_out_tmp                        : vector_of_signed14(0 TO 1000);  -- sfix14_En13 [1001]

BEGIN
  outputgen1: FOR k1 IN 0 TO 1000 GENERATE
    x_signed(k1) <= signed(x(k1));
  END GENERATE;

  vhdl_approximate_tanh_design_fixpt_1_output : PROCESS (x_signed)
    VARIABLE y : vector_of_signed32(0 TO 1000);
    VARIABLE y_0 : vector_of_signed32(0 TO 1000);
    VARIABLE b : vector_of_signed32(0 TO 1000);
    VARIABLE z1 : vector_of_signed32(0 TO 1000);
    VARIABLE tmp : signed(31 DOWNTO 0);
    VARIABLE cast : vector_of_real(0 TO 1000);
    VARIABLE div_temp : vector_of_real(0 TO 1000);
    VARIABLE mul_temp : vector_of_signed29(0 TO 1000);
    VARIABLE cast_0 : vector_of_signed28(0 TO 1000);
    VARIABLE cast_1 : vector_of_signed28(0 TO 1000);
    VARIABLE cast_2 : vector_of_unsigned32(0 TO 1000);
    VARIABLE sll_temp : vector_of_unsigned32(0 TO 1000);
    VARIABLE add_temp : vector_of_signed33(0 TO 1000);
    VARIABLE sub_temp : vector_of_signed33(0 TO 1000);
    VARIABLE cast_3 : vector_of_signed32(0 TO 1000);
  BEGIN
  ...
  outputgen: FOR k1 IN 0 TO 1000 GENERATE
